...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 07 Jun 2020 pada 10.24
...
(113, 'Andreas Peter Chandra', 'hiyahiya@gmail.com');
...
--
ALTER TABLE `pelanggan`
  MODIFY `id_pelanggan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=149;
